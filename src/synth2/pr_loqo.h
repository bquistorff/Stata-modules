...
/* Brian Quistorff. 2015-08-29
 * PR LOQO original site (offline) :https://web.archive.org/web/19991010071956/http://svm.first.gmd.de/software/loqosurvey.html
 * Downloaded from http://www.kernel-machines.org/code/prloqo.tar.gz/view
 * Author's website (PR LOQO not available there) http://alex.smola.org/
 * Modifications: Changed the printfs to ST_ printfs
 */ 
 
#if !defined(PR_LOQO_H)
#define PR_LOQO_H
